// Converted from Cypress: tests/cypress/integration/core/isNodeEmpty.spec.ts
...
describe('isNodeEmpty', () => {
  ...
  describe('ignoreWhitespace=true option', () => {
  ...
  describe('with default schema', () => {
    ...
    it('should return true when a paragraph has attributes but no content', () => {
      const node = schema.nodeFromJSON({
        type: 'paragraph',
        content: [],
        attrs: {
    ...
    it('should return true when a paragraph has marks but no content', () => {
      const node = schema.nodeFromJSON({
        type: 'paragraph',
        content: [],
        attrs: {
  ...
  describe('with modified schema', () => {
    ...
    it('should return true when a document has empty heading and paragraph', () => {
      const node = modifiedSchema.nodeFromJSON({
        type: 'doc',
        content: [
    ...
    it('should return true when a document has an empty heading with attributes', () => {
      const node = modifiedSchema.nodeFromJSON({
        type: 'doc',
    ...
    it('should return true when document has empty heading and paragraph with attributes', () => {
      const node = modifiedSchema.nodeFromJSON({
        type: 'doc',
        content: [
    ...
    it('should handle image nodes correctly', () => {
