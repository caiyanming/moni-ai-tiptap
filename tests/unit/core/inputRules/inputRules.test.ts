...
import { textblockTypeInputRule, nodeInputRule, wrappingInputRule } from '@tiptap/core'

// Use custom extensions that have moniBlockId support
import { Blockquote } from '../../../../packages/extension-blockquote/src/blockquote.tsx'
import { HorizontalRule } from '../../../../packages/extension-horizontal-rule/src/horizontal-rule.ts'
...
describe('Input Rules - moniBlockId generation', () => {
  ...
  describe('Input Rules Integration', () => {
    ...
    it('should handle rapid input rule applications', () => {
      ...
      // Count unique IDs
      const ids = blockNodes
        .map(node => node.attrs.moniBlockId)
