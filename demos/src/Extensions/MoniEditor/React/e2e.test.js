...
const createMockEditor = () => {
  ...
  return {
    ...
    chain: vi.fn(function() { return this.commands }),
    can: vi.fn(() => ({
      undo: vi.fn(() => true),
      redo: vi.fn(() => false)
    })),
    ...
    getText: vi.fn(() => 'MoniAI TipTap Editor Demo This demo showcases the MoniAI TipTap editor with custom extensions'),
    isEditable,
...
describe('🎭 MoniAI Editor Demo - 端到端测试', () => {
  ...
  describe('🎯 完整用户工作流测试', () => {
    ...
    it('用户应该能够自定义 AI 操作并进行精细控制', async () => {
      ...
      const customContent = '<h2>Custom AI Generated Heading</h2><p>This is custom content generated through the simulator.</p>'
